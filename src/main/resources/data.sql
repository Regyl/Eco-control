...
INSERT INTO organization(id, inn, name, latitude, longitude, organization_type, is_okved_danger,
                         address, pollution_type)
VALUES (uuid_generate_v4(), 7710044140, 'ООО «Макдоналдс»', 55.157428, 61.395098, 'LEGAL_ORGANIZATION', false,
...
INSERT INTO organization(id, inn, name, latitude, longitude, organization_type, is_okved_danger,
                         address, pollution_type)
VALUES (uuid_generate_v4(), 7460033022, 'ООО «Воровского 62»', 55.141629, 61.374877, 'LEGAL_ORGANIZATION', false,
...
INSERT INTO organization(id, inn, name, latitude, longitude, organization_type, is_okved_danger,
                         address, pollution_type)
VALUES (uuid_generate_v4(), 7451194577, 'ОАО «Челябкоммунэнерго»', 55.136915, 61.371930, 'LICENSED', true,
...
INSERT INTO organization(id, inn, name, latitude, longitude, organization_type, is_okved_danger,
                         address, pollution_type)
VALUES (uuid_generate_v4(), 7447067833, 'ООО «Заречный колхозный рынок»', 55.174702, 61.398053, 'LEGAL_ORGANIZATION', false,
...
INSERT INTO organization(id, inn, name, latitude, longitude, organization_type, is_okved_danger,
                         address, pollution_type)
VALUES (uuid_generate_v4(), 7047118990, 'ООО «Модус»', 55.175493, 61.385872, 'LICENSED', true,
        'г. Челябинск, Свердловский проспект, 32', 'SOIL');

INSERT INTO organization(id, inn, name, latitude, longitude, organization_type, is_okved_danger,
                         address, pollution_type)
VALUES (uuid_generate_v4(), 7453022326, 'МУП Дворец спорта «ЮНОСТЬ»', 55.169020, 61.391253, 'LEGAL_ORGANIZATION', false,
...
INSERT INTO organization(id, inn, name, latitude, longitude, organization_type, is_okved_danger,
                         address, pollution_type)
VALUES (uuid_generate_v4(), 7247245282, 'ООО «Грэкс»', 55.184099, 61.297289, 'LICENSED', false,
        'г. Челябинск, проспект Победы 319', 'SOIL');

INSERT INTO organization(id, inn, name, latitude, longitude, organization_type, is_okved_danger,
                         address, pollution_type)
VALUES ('fff01741-5248-45de-9979-374cb90a99a2', 7147245282, 'ООО "Уралпротект"', 55.182336, 61.344123, 'POTENTIAL_DANGER', true,
        'г. Челябинск, проспект Победы 319', 'SOIL');

INSERT INTO organization(id, inn, name, latitude, longitude, organization_type, is_okved_danger,
                         address, pollution_type)
VALUES (uuid_generate_v4(), 7547245282, 'Уральская Химическая Компания', 55.177218, 61.355918, 'LEGAL_ORGANIZATION', false,
